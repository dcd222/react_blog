...
// 后端接口
live2d_settings['modelAPI']             = '//codingman.space/live2d/';   // 自建 API 修改这里
...
function initModel(result, type) {
    // waifuPath = waifuPath  ||  './assets/waifu-tips.json'
...
// import json from './waifu-tips.json';
